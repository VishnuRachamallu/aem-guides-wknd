...
class SimpleResourceListenerTest {
	...
	/*
	 * @Test void handleEvent() { Event resourceEvent = new Event("event/topic",
	 ...
	 * events.size()); LoggingEvent event = events.get(0);
	 * 
	 * assertAll( () -> assertEquals(Level.DEBUG, event.getLevel()), () ->
